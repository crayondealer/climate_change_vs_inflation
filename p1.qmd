...
temperature|>
  ...
  theme(plot.title = element_text(hjust = 0.5), 
        ...
        plot.margin = unit(c(0, 0.5, 0, 0.5), "inches")) +
...
ghg_types_long |>
  ...
  geom_label_repel(data=forest_long, 
            aes(y = Value, label="y"),
                  nudge_x = 1,
                  na.rm = TRUE) +
...
ghg_long |>
  ...
  geom_bar(stat = "identity", position = "stack", color = "white", width=0.75, alpha=0.75, linewidth=1) +
  theme_minimal() + 
  theme(
    plot.title = element_text(hjust = 0.5),
